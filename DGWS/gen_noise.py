...
->kindPSD  : noise type: 'flat' or 'analytic' (Default is g. flat).
...
class GenNoise:
    ...
    def __init__(self,Ttot=1,fe=2048,kindPSD='flat',nsamp=160,fmin=20,fmax=1500,whitening=1,verbose=False):
    ...
    def _genPSD(self):
        ...
        self.__invPSD=npy.sqrt(1./self.__PSD)
